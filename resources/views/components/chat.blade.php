...
<div class="hidden bg-blue-100  dark:bg-blue-900/50 ">
  bg-blue-100 dark:bg-blue-900/50
</div>
<div class="hidden bg-green-100  dark:bg-green-900/50 ">
  bg-green-100 dark:bg-green-900/50
</div>

<div class="flex justify-{{$posFlex}} ">
  <div
    class="max-w-[70%] px-3 py-2 rounded-xl bg-{{$blue}}-100 text-gray-800 shadow dark:bg-{{$blue}}-900/50 dark:text-gray-200">
