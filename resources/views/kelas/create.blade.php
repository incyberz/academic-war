<x-app-layout>
  ...
  <x-page-content>
    ...
    @if(isSuperAdmin() || $ZZZ)
    <x-super-admin description="Fitur ini akan membuat kelas massal untuk seluruh prodi/shift/rombel."
      :alert="'Ini adalah fitur level sistem. Jika TA aktif semester pendek, proses akan otomatis di-skip.'">
